...
int DatotekaDrzave(Point tablica, char* fileName);
...
int IspisDrzava(Point tablica);
int IspisGrad(Stablo root);
int PretragaDrzava(Point tablica);
int PretragaGradova(Stablo root, int broj, int* i);
int FreeAll(Point tablica);
